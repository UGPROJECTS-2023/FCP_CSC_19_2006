...
<div class="container-fluid">
	...
	<div class="contentheader">
			<i class="icon-group"></i> Parcel Users
			</div>
			<ul class="breadcrumb">
...
<a rel="facebox" href="addUser.php"><Button type="submit" class="btn btn-info" style="float:right; width:230px; height:35px;" />
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<td><a rel="facebox" href="edit_u.php?id=<?php echo $row['id']; ?>"><button class="btn btn-warning btn-mini"><i class="icon-edit"></i> Edit </button></a>
