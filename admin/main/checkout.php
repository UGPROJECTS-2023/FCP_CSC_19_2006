...
<div id="ac">
<center><h4><i class="icon icon-money icon-large"></i> Message!!!</h4></center><hr>
...
?><button class="btn btn-success btn-block btn-large" style="width:267px;"><i class="icon icon-save icon-large"></i> Comfirm</button>
</center>
</div>
</form>
</body>
